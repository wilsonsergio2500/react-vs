...
var index_1 = require('../../components/loading-button-component/index');
var LoadingButtonComponentUsage = (function (_super) {
    __extends(LoadingButtonComponentUsage, _super);
    function LoadingButtonComponentUsage() {
        _super.apply(this, arguments);
    }
    LoadingButtonComponentUsage.prototype.componentWillMount = function () {
        this.setState({ gotBusy: false });
    };
    LoadingButtonComponentUsage.prototype.OnClick = function () {
        this.setState({
            gotBusy: true
        });
        var that = this;
    ...
    LoadingButtonComponentUsage.prototype.render = function () {
        var _this = this;
    ...
    return LoadingButtonComponentUsage;
}(React.Component));
exports.LoadingButtonComponentUsage = LoadingButtonComponentUsage;
//# sourceMappingURL=loading-button-component-usage.js.map